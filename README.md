...
Backend template for DynamiaTools using SpringBoot and Groovy. **Placeholder — scaffolding pending, see [framework#91](https://github.com/dynamiatools/framework/issues/91).**
